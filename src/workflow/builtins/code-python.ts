...
Your workspace is at /workspace containing the Python project repository.
...
- After modifying types → run mypy
...
- Never suppress errors by weakening types (adding \`Any\`, \`# type: ignore\`), disabling lint rules, or skipping tests.
